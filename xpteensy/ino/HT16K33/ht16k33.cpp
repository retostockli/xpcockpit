...
uint8_t HT16K33::set16Seg(uint8_t dig, uint8_t cha){ // position 0-15, 0-15 (0-F Hexadecimal)
  if (cha<128 && dig<8){
    ...
    //    displayRam[dig2+1] = BitReverseTable256[lowByte(seg16Chartable[cha])];
    //    displayRam[dig2] = BitReverseTable256[highByte(seg16Chartable[cha])];
    //    displayRam[dig2] = lowByte(seg16Chartable[cha]);
    //    displayRam[dig2+1] = highByte(seg16Chartable[cha]);
    displayRam[dig2] = lowByte(_seg16Font[cha]);
    displayRam[dig2+1] = highByte(_seg16Font[cha]);
