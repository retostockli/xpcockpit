/*=========================================================================
  ...
  Module:  ogcFontManager.cpp

  Copyright (c) 2001-2003 Damion Shelton
                2021-2024 Reto Stockli
  All rights reserved.
...
namespace OpenGC
{
  ...
  ::FontManager()
  {
    ...
    // By default, the font is a polygon without outline
    m_Outline = false;
  ...
  void
  FontManager
  ::SetOutline(bool flag)
  {
    m_Outline = flag;

    for(int i = 0; i < m_NumFonts; i++)
      {
	m_FontList[i]->SetOutline(flag);
      }
  }
