...
/* test lines only! 
    ...
    m_pFontManager->Print (10, 119, "abcdefghijklmnopqrstuvwxyz0123456789", m_Font); // Line 1 test
    m_pFontManager->Print (10, 100, "abcdefghijklmnopqrstuvwxyz0123456789", m_Font); // Line 2 test
    m_pFontManager->Print (10,  81, "abcdefghijklmnopqrstuvwxyz0123456789", m_Font); // Line 3 test
    m_pFontManager->Print (10,  62, "abcdefghijklmnopqrstuvwxyz0123456789", m_Font); // Line 4 test
    m_pFontManager->Print (10,  43, "abcdefghijklmnopqrstuvwxyz0123456789", m_Font); // Line 5 test
    m_pFontManager->Print (10,  24, "abcdefghijklmnopqrstuvwxyz0123456789", m_Font); // Line 6 test
    m_pFontManager->Print (10,   5, "abcdefghijklmnopqrstuvwxyz0123456789", m_Font); // Line 7 test
/**/
