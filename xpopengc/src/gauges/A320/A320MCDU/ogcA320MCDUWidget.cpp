...
//////////////////////////////////////////////////////////////////////
  ...
  void A320MCDUWidget::Render()
  {
	...
	int *cold_dark_mcdu = link_dataref_int ("xpserver/cold_and_dark");
	if (*cold_dark_mcdu == INT_MISS) coldDarkMcdu = 2; else coldDarkMcdu = *cold_dark_mcdu;
	if (coldDarkMcdu != 0) {
...
//printf("spec line 6: %s\nwhite line 6: %s\n", mcdu1_content6_spec, mcdu1_content6_white);
