...
=============================================================================
  ...
  The current status of the sub-pages is as follows:
...
//===========================The Render function===============================
  ...
  void A320NDWidget::Render()
  {
    ...
    int *cold_dark_nd  = link_dataref_int ("xpserver/cold_and_dark");
    if (*cold_dark_nd != INT_MISS) coldDarkNd = *cold_dark_nd; else coldDarkNd = 2;
    int *avionics_on   = link_dataref_int("sim/cockpit/electrical/avionics_on");
    if (*avionics_on  != INT_MISS) avionicsOn = *avionics_on; else avionicsOn = 0;
    if ((coldDarkNd == 0) && (avionicsOn == 1)) {
