/*=========================================================================
  ...
  Module:  $RCSfile: ogcB737NAVDrawStatic.h,v $
...
#ifndef ogcB737NAVDrawStatic_h
#define ogcB737NAVDrawStatic_h
...
class B737NAVDrawStatic : public GaugeComponent
{
public:

  B737NAVDrawStatic();
  virtual ~B737NAVDrawStatic();
