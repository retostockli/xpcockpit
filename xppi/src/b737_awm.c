...
void b737_awm(void)
{
  ...
  if (acf_type == 3) {
    ...
    float *fire_bell = link_dataref_flt("laminar/B738/annunciator/fire_bell_annun",0);
...
#ifdef PIGPIO
      gpioWrite(FIRE_BELL_PIN, (int) *fire_bell);
#else
      digitalWrite(FIRE_BELL_PIN, (int) *fire_bell);
#endif
    } else {
#ifdef PIGPIO
