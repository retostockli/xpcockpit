...
ssh du1  "systemctl --user restart xpopengc-du1"
ssh du2  "systemctl --user restart xpopengc-du2"
ssh eicas "systemctl --user restart xpopengc-eicas; systemctl --user restart xppi-compass"
