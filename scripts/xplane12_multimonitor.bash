...
cp ~/xpcockpit/warpblend/scripts/X-Plane\ Window\ Positions_NOWARPBLEND.prf ~/X-Plane\ 12\ PROD/Output/preferences/X-Plane\ Window\ Positions.prf
cp ~/xpcockpit/warpblend/scripts/X-Plane\ Window\ Positions_NOWARPBLEND_NEW.prf ~/X-Plane\ 12\ TEST/Output/preferences/X-Plane\ Window\ Positions.prf
##start xplane##
...
id=`wmctrl -l | grep X-System | awk '{ print $1 }'`
